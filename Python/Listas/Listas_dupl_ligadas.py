from Listas.No_dupl_ligadas import NoDuplamenteLigada
...
class ListaDuplamenteLigada():
    ...
    def inserir(self, elemento):
        novo_no = NoDuplamenteLigada(elemento)  # Cria um novo no, sem nenhuma ligaçao
        if self.estar_vazia():  # Verifica se a lista esta vazia
            ...
            novo_no.anteNo = self.__ultimo_no
            self.__ultimo_no = novo_no
    ...
    def inserir_posicao(self, elemento, posicao):
        ...
        if posicao == 0:
            novo_no = NoDuplamenteLigada(elemento)  # cria um novo No
            novo_no.proximoNo = self.__primeiro_no  # novo No aponta pro primeiro No atual da lista
            self.__primeiro_no.anteNo = novo_no
        ...
        # se quiser inserir no fim da lista
            ...
            novo_no.anteNo = self.__ultimo_no  # novo no tambem tem referencia para o penultimo No
        ...
        # significa que temos que pegar a posicao anterior a passada e a posicao apos a posicao passada
            ...
            no_anterior = no_atual.anteNo  # reupera uma posicao antes
            novo_no = NoDuplamenteLigada(elemento)  # cria novo No
            ...
            no_atual.anteNo = novo_no
            novo_no.anteNo = no_anterior
        self.__tamanho += 1
    ...
    def remover_posicao(self, posicao):
        ...
        if posicao == 0:
            ...
            self.__primeiro_no.proximoNo = None
            self.__primeiro_no.anteNo = None
        ...
        # caso queira rmover o ultimo No
            ...
            penultimo_no = self.__ultimo_no.anteNo  # pega a referencia do penultimo no da lista
            penultimo_no.proximoNo = None  # apaga a referecia para o ultimo no
            self.__ultimo_no.anteNo = None  # apaga a referencia do ultimo no para o penultimo No
        ...
        # remover um elemento que tenha no antes e depois
            ...
            no_anterior = no_remover.anteNo  # pega o No anterior
            no_posteriro = no_remover.proximoNo
            no_anterior.proximoNo = no_posteriro  # faz o no anterior apontar para o No seguinte ao da posicao
            no_posteriro.anteNo = no_anterior  # faz o no segunti ao que sera removido apontar para o anterior ao removido
            no_remover.proximoNo = None  # no que se deseja remover aponta pra nullo.python limpa
            no_remover.anteNo = None
